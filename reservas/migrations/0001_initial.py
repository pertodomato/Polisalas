# Generated by Django 4.2.5 on 2024-11-19 17:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('giz_canetao', models.CharField(max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Solicitacao',
            fields=[
                ...
                ('status', models.CharField(choices=[('Em análise', 'Em análise'), ('Aprovada', 'Aprovada'), ('Rejeitada', 'Rejeitada')], default='Em análise', max_length=10)),
                ('descricao', models.TextField(blank=True, null=True)),
                ('justificativa', models.TextField(blank=True, null=True)),
                ('salas', models.ManyToManyField(to='reservas.sala')),
                ('solicitante', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='reservas.grupoextensao')),
            ],
        ),
        migrations.CreateModel(
            name='AdministracaoPredial',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
